...
define( 'YOURLS_DB_USER', 'msi_user' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'test@pass12' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'msi_db' );

/** MySQL hostname.
 ** If using a non standard port, specify it like 'hostname:port', e.g. 'localhost:9999' or '127.0.0.1:666' */
define( 'YOURLS_DB_HOST', 'localhost:3360' );
...
define( 'YOURLS_SITE', 'http://msi.yoowills.local/s/' );
...
define( 'YOURLS_COOKIEKEY', '2qQ4RhL_pu|s@Z7n#%:b^{A[hm0' );

/** Username(s) and password(s) allowed to access the site. Passwords either in plain text or as encrypted hashes
 ** YOURLS will auto encrypt plain text passwords in this file
 ** Read http://yourls.org/userpassword for more information */
$yourls_user_passwords = [
	'admin' => 'phpass:!2y!10!AF8k9eCcMh5TcJo8ueNJiOjMjf03ndTXMNdml5dAP3Jl7BG0QJTXa' /* Password encrypted by YOURLS */  ,
	// 'username2' => 'password2',
