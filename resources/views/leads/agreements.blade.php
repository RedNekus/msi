    ...
    <form class="lead-form" action="/lead/add/agreements" method="POST">
        ...
        <div class="lead-form__link"><a href="#">Посмотреть согласие на предоставление кредитного отчета</a></div>
          <div class="lead-form__check">
            <input class="lead-form__check-input" type="checkbox" name="agreement_report" id="agreement_report">
          ...
          <div class="lead-form__check">
            <input class="lead-form__check-input" type="checkbox" name="agreement_personal" id="agreement_personal">
          ...
          <div class="lead-form__check">
            <input class="lead-form__check-input" type="checkbox" name="agreement_politic" id="agreement_politic">
